    ...
    return(
        <section className="navbar">
            ...
            <div className="checkbox-wrapper">
                ...
                <input className="tgl tgl-skewed" id="cb3-8" type="checkbox" checked={props.darkMode} onChange={props.toggleDarkMode}/>
                <label className="tgl-btn" data-tg-off="OFF" data-tg-on="ON" htmlFor="cb3-8"></label>
            </div>
        </section>
    );
}